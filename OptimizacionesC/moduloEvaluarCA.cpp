...
py::list generarRelacionesArbolGrande(long long int filas, long long int columnas, py::list B, py::list S) {
...
PYBIND11_MODULE(OptimizacionesC, m) {
    ...
    m.def("generarRelacionesArbolGrande", &generarRelacionesArbolGrande, "Genera las relaciones del arbol de relaciones de estados (Mayor a 5x5).");
}